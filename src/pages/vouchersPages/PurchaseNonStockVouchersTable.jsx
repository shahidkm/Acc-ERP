...
import { useGetPurchaseNonStockVouchers } from '../../hooks/vouchersHooks/vouchersHook';
import Sidebar from "../../components/sidebar/Sidebar";

const PurchaseNonStockVouchersTable = () => {
  const { data: purchaseVouchers, isLoading, error } = useGetPurchaseNonStockVouchers();
  ...
  const vouchers = purchaseVouchers || [];
  ...
  const handleCreateNew = () => {
    navigate("/purchase-non-stock-voucher");
  };
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-full mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Purchase Vouchers</h3>
            <p className="text-gray-600">Failed to fetch purchase non-stock vouchers</p>
            <button 
      ...
      <div className="max-w-full mx-auto">
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Purchase Non-Stock Vouchers</h1>
              <p className="text-gray-600 mt-1">Manage and view all purchase non-stock voucher entries</p>
            </div>
            <button
        ...
        {filteredVouchers.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Purchase Vouchers Found</h3>
            <p className="text-gray-600">
              {searchTerm || statusFilter !== 'all' ? 'Try adjusting your filters.' : 'No purchase vouchers are available at the moment.'}
            </p>
          </div>
        ) : (
          <>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-gray-900">Purchase Non-Stock Voucher Details</h2>
                  <button
...
export default PurchaseNonStockVouchersTable;