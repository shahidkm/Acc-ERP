...
// Mock hook for demo
import { useGetJournalVouchers } from '../../hooks/vouchersHooks/vouchersHook';
const JournalVoucherTable = () => {
  const { data: journalVouchers, isLoading, error } = useGetJournalVouchers();
  ...
  const vouchers = journalVouchers || [];
const navigate =useNavigate()
  ...
  const handleCreateNew = () => {
   navigate("/create-journal-voucher");
  };
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-full mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Journal Vouchers</h3>
            <p className="text-gray-600">Failed to fetch journal vouchers</p>
            <button 
...
<Sidebar/>
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Journal Vouchers</h1>
              <p className="text-gray-600 mt-1">Manage and view all journal voucher entries</p>
            </div>
            <button
        ...
        <div className="mb-6 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search by voucher number, remarks, or creator..."
                value={searchTerm}
        ...
        {filteredVouchers.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Journal Vouchers Found</h3>
            <p className="text-gray-600">
              {searchTerm || statusFilter !== 'all' ? 'Try adjusting your filters.' : 'No journal vouchers are available at the moment.'}
            </p>
          </div>
        ) : (
          <>
                      ...
                      <tr key={voucher.voucherId} className={`hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-25'}`}>
                        ...
                        <td className="px-6 py-4">
                          <div className="text-sm text-gray-900 max-w-xs truncate">
                            {voucher.remarks || <span className="text-gray-400 italic">No remarks</span>}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full border border-gray-200">
                    ...
                    <tfoot className="bg-gray-50 font-semibold">
                      <tr>
                        <td colSpan="4" className="px-4 py-2 text-right">Total Debit:</td>
                        <td className="px-4 py-2 text-right text-red-600">{formatCurrency(selectedVoucher.totalDebit)}</td>
                      </tr>
                      <tr>
                        <td colSpan="4" className="px-4 py-2 text-right">Total Credit:</td>
