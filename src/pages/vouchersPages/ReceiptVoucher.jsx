...
import { useCreateVoucher } from '../../hooks/vouchersHooks/vouchersHook';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-[#f29f67]/10 p-3 rounded-lg">
              <Receipt className="h-8 w-8 text-[#f29f67]" />
            </div>
            <div>
              <h1 className="text-2xl font-semibold text-gray-900">New Receipt Voucher</h1>
              <p className="text-gray-500">Create a new receipt voucher entry</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">Receipt voucher created successfully</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-red-700 text-sm">
                  {createVoucherMutation.error?.message || 'Failed to create voucher'}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Voucher Type <span className="text-[#f29f67]">*</span>
                </label>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Account <span className="text-[#f29f67]">*</span></th>
                    ...
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Amount <span className="text-[#f29f67]">*</span></th>
