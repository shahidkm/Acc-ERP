...
function JournalVoucher() {
  ...
  const [entries, setEntries] = useState([
    { id: 1, type: 'debit', account: '', description: '', reference: '', jobCode: '', costCenterCode: '', amount: 0 },
    { id: 2, type: 'credit', account: '', description: '', reference: '', jobCode: '', costCenterCode: '', amount: 0 }
  ]);
  ...
  const resetForm = () => {
    ...
    setEntries([
      { id: Date.now(), type: 'debit', account: '', description: '', reference: '', jobCode: '', costCenterCode: '', amount: 0 },
      { id: Date.now() + 1, type: 'credit', account: '', description: '', reference: '', jobCode: '', costCenterCode: '', amount: 0 }
    ]);
  };
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Create a new journal voucher entry</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">Journal voucher created successfully</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-red-700 text-sm">
                  {createVoucherMutation.error?.message || 'Failed to create journal voucher'}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-yellow-700 text-sm">Failed to load account categories. Please refresh the page.</p>
              </div>
            </div>
          </div>
        )}
        ...
        {jobsError && (
          <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-yellow-800 font-medium">Warning</p>
                <p className="text-yellow-700 text-sm">Failed to load job masters. Please refresh the page.</p>
              </div>
            </div>
          </div>
        )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Voucher Type <span className="text-orange-500">*</span>
                </label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Voucher No. <span className="text-orange-500">*</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-9 pr-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 ${
                  ...
                  />
                  {!validations.voucherNo.isValid && (
                    <p className="mt-1 text-sm text-red-600">{validations.voucherNo.message}</p>
                  )}
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Voucher Date <span className="text-orange-500">*</span>
                </label>
                <div className="relative">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                {(isLoadingAccounts || isLoadingJobs) && (
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-1.5 text-sm bg-white border border-orange-500 text-orange-500 rounded-md hover:bg-orange-50 transition-colors"
                >
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Account <span className="text-orange-500">*</span></th>
                    ...
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Job Code</th>
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Cost Center</th>
                    <th className="text-left py-3 px-3 text-sm font-medium text-gray-700">Amount <span className="text-orange-500">*</span></th>
                    ...
                    <tr key={entry.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-3">
                        <div className="relative">
                          <select
                            ...
                            className="w-full px-2 py-1 pr-8 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 appearance-none bg-white"
                          >
                      ...
                      <td className="py-3 px-3">
                        <input
                          ...
                          className="w-full px-2 py-1 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500"
                        />
                      </td>
                      <td className="py-3 px-3">
                        <input
                      ...
                      <td className="py-3 px-3">
                        <div className="relative">
                          <select
                            value={entry.jobCode}
                            onChange={(e) => handleEntryChange(entry.id, 'jobCode', e.target.value)}
                            disabled={isLoadingJobs}
                            className="w-full px-2 py-1 pr-8 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-orange-500 focus:border-orange-500 appearance-none bg-white"
                          >
                            <option value="">Select Job</option>
                            {jobMasters?.map((job) => (
                              <option key={job.id} value={job.jobCode}>
                      ...
                      <td className="py-3 px-3">
                        <input
                          type="text"
                          value={entry.costCenterCode}
                          onChange={(e) => handleEntryChange(entry.id, 'costCenterCode', e.target.value)}
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  type="button"
                  onClick={resetForm}
                  className="px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-500 transition-colors"
                ...
                <button
                  ...
                  disabled={createVoucherMutation.isPending || !isFormValid || isLoadingAccounts || isLoadingJobs}
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                    createVoucherMutation.isPending || !isFormValid || isLoadingAccounts || isLoadingJobs
