      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-full mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Customer Receipt Vouchers</h3>
            <p className="text-gray-600">Failed to fetch customer receipt vouchers</p>
            <button 
      ...
      <div className="max-w-full mx-auto">
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Customer Receipt Vouchers</h1>
              <p className="text-gray-600 mt-1">Manage and view all customer receipt voucher entries</p>
            </div>
            <button
        ...
        {filteredVouchers.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Customer Receipt Vouchers Found</h3>
            <p className="text-gray-600">
              {searchTerm || statusFilter !== 'all' ? 'Try adjusting your filters.' : 'No customer receipt vouchers are available at the moment.'}
            </p>
          </div>
        ) : (
          <>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-gray-900">Customer Receipt Voucher Details</h2>
                  <button
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  ...
                  {selectedVoucher.jobCodeId && (
                    <div>
                      <p className="text-sm text-gray-600">Job Code ID</p>
                      <div className="flex items-center gap-2 mt-1">
                        <Briefcase className="h-4 w-4 text-gray-500" />
                        <p className="font-medium text-gray-900">{selectedVoucher.jobCodeId}</p>
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  <table className="min-w-full border border-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-700">Party Name</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-700">Description</th>
                        <th className="px-4 py-2 text-left text-xs font-medium text-gray-700">Bank/Cheque</th>
                    ...
                    <tbody className="divide-y divide-gray-200">
                      {selectedVoucher.lines.map((line) => (
                        <tr key={line.lineId}>
                          ...
                          <td className="px-4 py-2 text-sm text-gray-900">{line.partyName || '-'}</td>
                          <td className="px-4 py-2 text-sm text-gray-900">{line.description}</td>
                          <td className="px-4 py-2 text-sm text-gray-900">
                            {line.bankName && (
                              <div>
                                <div className="font-medium">{line.bankName}</div>
                                {line.chequeNo && (
                    ...
                    <tfoot className="bg-gray-50 font-semibold">
                      <tr>
                        <td colSpan="6" className="px-4 py-2 text-right">Total Debit:</td>
                        <td className="px-4 py-2 text-right text-red-600">{formatCurrency(selectedVoucher.totalDebit)}</td>
                      </tr>
                      <tr>
                        <td colSpan="6" className="px-4 py-2 text-right">Total Credit:</td>
...
export default CustomerReceiptVoucherTable;