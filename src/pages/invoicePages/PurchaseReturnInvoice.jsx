...
import { useCreatePurchaseReturn } from '../../hooks/purchaseReturnHooks/purchaseReturnHooks';
import { useGetAccountMasters } from '../../hooks/accountHooks/accountHooks';
import { useGetSuppliers } from '../../hooks/supplierHooks/useGetSuppliers';
...
import { useGetPurchaseInvoices } from '../../hooks/purchaseHooks/purchaseHooks';
import {
  Save,
  Loader,
  AlertCircle,
...
const CreatePurchaseReturn = () => {
  ...
  const { mutate, isPending, isSuccess, isError, error } = useCreatePurchaseReturn();
  ...
  const { data: purchaseInvoices, isLoading: purchaseInvoicesLoading } = useGetPurchaseInvoices();
  ...
  const handleSubmit = (e) => {
    ...
    if (updatedJournalLines.length > 0) {
      updatedJournalLines[0].purchaseItems = returnItems.map(item => ({
    ...
    const submitData = {
      ...
      purchaseId: parseInt(formData.purchaseId) || 0,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 border border-white/50 shadow-xl">
            ...
            <p className="text-gray-600 text-lg">Return purchased items to supplier with credit adjustments</p>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="group">
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300 disabled:opacity-50"
                  >
                ...
                <div className="group lg:col-span-3">
                  ...
                  <textarea
                    ...
                    rows="3"
                    className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-orange-500/20 focus:border-orange-500 transition-all duration-300"
                    placeholder="Enter reason for return (e.g., defective goods, wrong items, quality issues)..."
                  />
                </div>
              </div>
            </div>
            ...
            <div className="p-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 bg-orange-500 text-white font-medium rounded-lg hover:bg-orange-600 transition-colors duration-200"
                >
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-white/50 shadow-xl overflow-hidden">
            <div className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-amber-100 rounded-xl p-6 space-y-4">
                  ...
                  <div className="border-t border-orange-300 pt-3">
                    <div className="flex justify-between items-center text-lg">
                      ...
                      <span className="font-bold text-orange-600">{formatCurrency(formData.grandTotal)}</span>
                    </div>
                  </div>
                  
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-gray-600">Net Credit Amount:</span>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-6 border border-orange-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-white/50 rounded-lg p-4">
                <p className="text-sm font-medium text-orange-800">Voucher No.</p>
                <p className="text-orange-900">{formData.voucherNo || 'Not set'}</p>
              </div>
              <div className="bg-white/50 rounded-lg p-4">
                <p className="text-sm font-medium text-orange-800">Reference</p>
                <p className="text-orange-900">{formData.referenceNo || 'Not set'}</p>
              </div>
              <div className="bg-white/50 rounded-lg p-4">
                <p className="text-sm font-medium text-orange-800">Return Items</p>
                <p className="text-orange-900">{returnItems.length} item(s)</p>
              </div>
              <div className="bg-white/50 rounded-lg p-4">
                <p className="text-sm font-medium text-orange-800">Journal Lines</p>
                <p className="text-orange-900">{journalLines.length} line(s)</p>
              </div>
            </div>
          </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 shadow-lg">
                <div className="flex items-center gap-3 text-green-700">
                  ...
                  <div>
                    ...
                    <p className="text-sm">Purchase return has been created successfully.</p>
                  </div>
                </div>
              </div>
            )}
