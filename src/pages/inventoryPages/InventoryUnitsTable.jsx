...
const InventoryUnitsTable = () => {
  const { data: inventoryGroups, isLoading, error } = useGetInventoryUnits();
  ...
  const filteredGroups = useMemo(() => {
    ...
    let filtered = groups.filter(group => {
      const matchesSearch = searchTerm === '' || 
        ...
        (group.fraCount?.toString() || '').includes(searchTerm);
    ...
    filtered.sort((a, b) => {
      ...
      // Handle numeric sorting for fraCount
      if (sortField === 'fraCount') {
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-full mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Inventory Units</h3>
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-6 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder="Search by name, description, ID, or FRA count..."
                value={searchTerm}
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="text-sm text-gray-600 font-medium">
              Showing {startIndex + 1} to {Math.min(endIndex, filteredGroups.length)} of {filteredGroups.length} inventory units
        ...
        {filteredGroups.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Inventory Units Found</h3>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th 
                        onClick={() => handleSort('fraCount')}
                        className="px-6 py-4 text-left text-xs font-semibold text-gray-900 uppercase tracking-wider cursor-pointer hover:bg-gray-100 transition-colors"
                      >
                        <div className="flex items-center gap-2">
                          <BarChart3 className="h-4 w-4" />
                          FRA Count
                          <span className="text-gray-400">{getSortIcon('fraCount')}</span>
                        </div>
                      </th>
                    </tr>
                  </thead>
...
export default InventoryUnitsTable;