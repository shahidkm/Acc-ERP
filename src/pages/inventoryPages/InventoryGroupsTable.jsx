...
import { useGetInventoryGroups } from '../../hooks/inventoryHooks/useGetInventoryGroup';
import { 
  Package, 
  Search, 
  AlertCircle, 
...
const InventoryGroupsTable = () => {
  const { data: inventoryGroups, isLoading, error } = useGetInventoryGroups();
      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Inventory Groups</h1>
              <p className="text-gray-600 mt-1">Manage and view all inventory group categories</p>
            </div>
            <button
