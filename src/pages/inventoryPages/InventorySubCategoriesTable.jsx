...
import { useGetInventorySubCategories } from '../../hooks/inventoryHooks/useGetInventoryCategory';
import { 
  Package, 
  Search, 
  AlertCircle, 
...
const InventorySubCategoriesTable = () => {
  const { data: inventoryGroups, isLoading, error } = useGetInventorySubCategories();
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-full mx-auto">
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Error Loading Inventory Sub Categories</h3>
      ...
      <div className="max-w-full mx-auto">
        ...
        {filteredGroups.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">No Inventory Sub Categories Found</h3>
...
export default InventorySubCategoriesTable;