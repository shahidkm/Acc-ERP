...
import { useCreateInventoryGroup } from '../../hooks/inventoryHooks/useCreateInventoryGroup';
...
function CreateGroup() {
    ...
    const createGroupMutation = useCreateInventoryGroup();
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Create Inventory Group</h1>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-gray-100 px-8 py-6 border-b border-gray-200">
                        ...
                        <p className="text-gray-600 mt-2">Fill in the details below to create a new inventory group</p>
                    </div>
