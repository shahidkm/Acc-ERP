// components/ItemsSection.jsx
import React from 'react';
import { useDispatch } from 'react-redux';
import { updateItem, updateItemGst, removeItem, addItem } from "../../../../../redux/slices/voucher";
                        ...
                        <div className='flex justify-end mt-3'>
                            <div className='bg-blue-100 p-2 rounded-md w-48 text-right'>
                                <span className='font-medium text-blue-800'>
                                    ...
                                    (item.quantity * item.rate * (item.gst.cgstPercent + item.gst.sgstPercent + item.gst.igstPercent) / 100)).toFixed(2)}
                                </span>
                            </div>
                        </div>
                    </div>
